...
**[school-library]** In this project, I will start building a school library app. In this initial step, I will implement the classes to represent students and teachers.
...
- cd school-library
- `git clone https://github.com/KAYEMBAJONATHAN/school-library.git`
...
Feel free to check the [issues page](https://github.com/KAYEMBAJONATHAN/school-library/issues).
